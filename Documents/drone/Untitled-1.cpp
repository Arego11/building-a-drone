...
The original project is created by and belongs to Carbon Aeronautics, I made a couple of changes to fit my needs.
...
void setup() {
  ...
  for (int i = 1; i <= 4; i++) {
    analogWrite(i, 1000);  // Send minimum throttle signal
  }
  delay(5000);    
